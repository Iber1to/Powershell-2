...
function launchPass {
    ...
    'EMEA' { $adUser = 'SVC_CMDB_EMEA'; $server = 'emea.contoso.local' }
    'LATAM1' { $adUser = 'SVC_CMDB_LATAM1'; $server = 'latam1.contoso.local' }
    'LATAM2' { $adUser = 'SVC_CMDB_LATAM2'; $server = 'latam2.contoso.local' }
    'APAC' { $adUser = 'SVC_CMDB_APAC'; $server = 'apac.contoso.local' }
    'NA' { $adUser = 'SVC_CMDB_NA'; $server = 'na.contoso.local' }
}
