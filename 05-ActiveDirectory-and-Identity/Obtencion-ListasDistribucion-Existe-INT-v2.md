# Obtencion-ListasDistribucion-Existe-INT-v2.ps1

Script de **descubrimiento para una migración de AD/Exchange**: comprueba qué listas de distribución del dominio origen **ya existen** en el dominio destino ("INT").
