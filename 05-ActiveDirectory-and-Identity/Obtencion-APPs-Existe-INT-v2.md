# Obtencion-APPs-Existe-INT-v2.ps1

Script de **descubrimiento para una migración de AD/Exchange**: comprueba qué cuentas/aplicaciones del dominio origen **ya existen** en el dominio destino ("INT").
