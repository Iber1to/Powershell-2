...
$scriptname = "CreateScheduledTask"
...
Write-CMTracelog "Start Script: ${scriptname}"
# Create Files to correct paths
Write-CMTracelog "Create Files to correct paths"
...
function Update-FileToAzureBlob {
    ...
    # Codificar el contenido JSON a bytes
    $Encoding = [System.Text.Encoding]::UTF8
    $FileContent = $Encoding.GetBytes($JsonContent)
    ...
    # Llamada PUT a la API REST para subir el archivo
        ...
        # Devolver el código de estado HTTP de la operación
}
...
$file | Out-File "$($env:windir)\Temp\VendorIT\InventoryDevice001.ps1" -Encoding utf8

# Create Scheduled task
Write-CMTracelog "Create Scheduled Task"
$ScheduleXMl = '<?xml version="1.0" encoding="UTF-16"?>
	<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
	  ...
	  <Triggers>
		...
		<LogonTrigger />
		<EventTrigger>
		  <Subscription>&lt;QueryList&gt;&lt;Query Id="0" Path="Application"&gt;&lt;Select Path="Application"&gt;*[System[Provider[@Name="Application"] and EventID=11707]]&lt;/Select&gt;&lt;/Query&gt;&lt;/QueryList&gt;</Subscription>
		</EventTrigger>
	  </Triggers>
	  <Actions Context="Author">
		<Exec>
		  <Command>powershell.exe</Command>
		  <Arguments>-file "C:\Windows\Temp\VendorIT\InventoryDevice001.ps1" -executionpolicy bypass</Arguments>
		</Exec>
	  </Actions>
	</Task>'

$taskName = "InventoryDevice001"
register-ScheduledTask -TaskName $taskName -Xml $ScheduleXMl -Force
Write-CMTracelog "End Script: ${scriptname}"
Exit 0