...
$installTitle = "SoapUI" # Use this variable with *$instantTitle* to kill processes if app is running check processes name before set variable
$UninstallFilePath = "C:\Program Files\SmartBear\SoapUI-5.8.0\uninstall.exe"
$Argumenlist = "-q"
...
$processes = Get-Process -Name "*$($installTitle)*" -ErrorAction SilentlyContinue
if ($processes) {
