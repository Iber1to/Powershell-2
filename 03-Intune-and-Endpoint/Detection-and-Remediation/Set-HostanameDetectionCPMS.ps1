Start-Transcript -Path "C:\Windows\Temp\Set-HostanameDetection.log" -Force
...
If($CheckRecord1 -and $CheckRecord2){
    Write-Output "Found record for jvhost01.corp.ClientUtility.com2 y evplatform.corp.ClientUtility.com"
    Exit 0
}
Else{
