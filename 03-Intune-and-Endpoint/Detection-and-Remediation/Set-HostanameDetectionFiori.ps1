...
$CheckRecord = Get-HostsRecord -HostName "vhbptprdci.sap.tangerine.private"

If($CheckRecord){
    Write-Output "Found record for vhbptprdci.sap.tangerine.private con valor $checkRecord"
    Exit 0
}
Else{
    Write-Output "No record for vhbptprdci.sap.tangerine.private"
    Exit 1
}
Stop-Transcript