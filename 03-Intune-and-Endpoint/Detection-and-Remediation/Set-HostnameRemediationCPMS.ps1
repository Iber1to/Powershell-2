...
$CheckRecord1 = Get-HostsRecord -HostName "jvhost01.corp.ClientUtility.com"
$CheckRecord2 = Get-HostsRecord -HostName "evplatform.corp.ClientUtility.com"

if($null -eq $CheckRecord1){Set-HostsRecord -HostName "jvhost01.corp.ClientUtility.com" -IPAddress "198.51.100.812"}
if($null -eq $CheckRecord2){Set-HostsRecord -HostName "evplatform.corp.ClientUtility.com" -IPAddress "198.51.100.813"}
