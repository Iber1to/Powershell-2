...
$LimitingCollection = "00-GLOBAL_MGM_WS_(Principal_Coll)"
#$LimitingCollection = "All Workstations"
...
$FolderPath = $SiteCode.name+":\DeviceCollection\Colecciones basadas en Boundary Groups"
$testpathfolder = Test-Path -Path $FolderPath
if($testpathfolder){}
else{new-item -NAme 'Colecciones basadas en Boundary Groups' -Path $($SiteCode.Name+":\DeviceCollection")}
