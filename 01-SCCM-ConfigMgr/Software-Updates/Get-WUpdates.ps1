Function Get-WindowsUpdatesInstall
{
	...
	.DESCRIPTION
		...
		- Pre search works on server side, like example: ( IsInstalled = 0 and IsHidden = 0 and CategoryIds contains '11111111-1111-1111-1111-000000000053' )
	...
	.PARAMETER UpdateID
		Pre search criteria. Finds updates of a specific UUID (or sets of UUIDs), such as '11111111-1111-1111-1111-000000000054'.
	...
	.PARAMETER CategoryIDs
		Pre search criteria. Finds updates that belong to a specified category (or sets of UUIDs), such as '11111111-1111-1111-1111-000000000053'.
...
powercfg.exe -SETACTIVE 11111111-1111-1111-1111-000000000055

# I request available software updates, from the internet silently and without rebooting. 
$CallUpdates = Get-WindowsUpdatesInstall -AcceptAll -IgnoreReboot -UpdateType Software -WindowsUpdate  #To use a WSUS server, change the -WindowsUpdate option to -MicrosoftUpdate
$registryOuput= ($CallUpdates | Where-Object -FilterScript {$_.status -eq 'Installed'}).Title.split('('')')[1]

#I return to the energy configuration I had at the beginning. 
powercfg.exe -SETACTIVE $energyPlan
Write-Output $registryOuput